...
CREATE TABLE `cart_game` (
  ...
  PRIMARY KEY (`cart_id`,`game_id`,`quantity`),
  KEY `FKkcskao03o9uk8pqhmm818eq0e` (`game_id`),
  CONSTRAINT `FKf5sybwmj9uj44cos1kb2jojt1` FOREIGN KEY (`cart_id`) REFERENCES `cart` (`cart_id`),
  CONSTRAINT `FKkcskao03o9uk8pqhmm818eq0e` FOREIGN KEY (`game_id`) REFERENCES `game` (`game_id`)
